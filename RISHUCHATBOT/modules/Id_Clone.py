...
from RISHUCHATBOT import CLONE_OWNERS
from RISHUCHATBOT import RISHUCHATBOT as app, save_clonebot_owner, save_idclonebot_owner
from RISHUCHATBOT import RISHUCHATBOT, db as mongodb
