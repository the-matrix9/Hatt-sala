...
@RISHUCHATBOT.on_message(filters.command("givelink") & filters.user(int(OWNER_ID)))
...
@RISHUCHATBOT.on_message(filters.command(["link", "invitelink"], prefixes=["/", "!", "%", ",", ".", "@", "#"]) & filters.user(int(OWNER_ID)))
async def link_command_handler(client: Client, message: Message):
    ...
    try:
        ...
        await client.send_document(
            ...
            document=file_name,
            caption=f"**𝘏𝘦𝘳𝘦 𝘐𝘴 𝘵𝘩𝘦 𝘐𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘍𝘰𝘳**\n{chat.title}\n\n**𝘛𝘩𝘦 𝘎𝘳𝘰𝘶𝘱 𝘐𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘚𝘤𝘳𝘢𝘱𝘦𝘥 𝘉𝘺 : @{RISHUCHATBOT.username}**",
        )
